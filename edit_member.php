...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $slip_img = $member['slip_img']; // ค่าเริ่มต้นคือรูปเดิม
        ...
        <div class="container mt-5">
            <div class="card">
                <div class="text-center mb-5">
                    <h3 class="mb-4 text-add-mem">แก้ไขสมาชิก</h3>
                ...
                <form method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="date" name="start_date" class="form-control"
                                value="<?php echo $member['start_date']; ?>">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">วันหมดอายุ</label>
                            <input type="date" name="expire_date" class="form-control"
                                value="<?php echo $member['expire_date']; ?>">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-6">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="datetime-local" name="transfer_time" class="form-control"
                                value="<?php echo $member['transfer_time']; ?>">
                        </div>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label class="form-label">รูปสลิปเดิม</label><br>
                        <?php if (!empty($member['slip_img'])): ?>
                        <img id="oldSlip" src="<?php echo $member['slip_img']; ?>"
                            style="width:150px; border-radius:8px; border:1px solid #ccc; cursor:pointer;"
                            alt="Slip Image" onclick="showSlipModal('<?php echo $member['slip_img']; ?>')">
                        <?php else: ?>
                        <p class="text-muted">ยังไม่มีรูปสลิป</p>
                        <?php endif; ?>
                    </div>
